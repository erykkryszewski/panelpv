...
<div class="block-container container-cart">
  <div class="woocommerce-cols">
           ...
           if (
               ...
               $product_permalink = apply_filters(
                   ...
                   $cart_item_key,
    					...
    					<div class="woocommerce-cart-form__cart-item <?php echo esc_attr(
            ...
            echo apply_filters('woocommerce_cart_item_quantity', $product_quantity, $cart_item_key, $cart_item);
               ...
               ?>
											...
											<div class="product-subtotal" data-title="<?php esc_attr_e('Subtotal', 'woocommerce'); ?>">
												<span class="subtotal-text"><?php esc_html_e('Subtotal:', 'woocommerce'); ?></span>
												<strong>
													<?php echo apply_filters(
               ...
               ?>
                ...
                <div class="product-remove">
                  <?php echo apply_filters(
                      ...
                      sprintf(
                          '<a href="%s" class="remove" aria-label="%s" data-product_id="%s" data-product_sku="%s">Usuń produkt</a>',
                          esc_url(wc_get_cart_remove_url($cart_item_key)),
                          esc_html__('Usuń produkt', 'woocommerce'),
                          esc_attr($product_id),
    			...
    			<div>
    				<div colspan="6" class="actions">
    					...
    					<button type="submit" class="button button--update-cart" name="update_cart" value="<?php esc_attr_e(
             'Update cart',
             'woocommerce',
