...
<?php if (!WC()->cart->is_empty()): ?>
   ...
   foreach (WC()->cart->get_cart() as $cart_item_key => $cart_item) {
       ...
       if (
           ...
           ?>
						<li class="woocommerce-mini-cart-item <?php echo esc_attr(
          apply_filters('woocommerce_mini_cart_item_class', 'mini_cart_item', $cart_item, $cart_item_key),
      ); ?>">
...
<?php else: ?>
	<div class="flying-cart-content empty">
		...
		<a href="<?php echo get_the_permalink($shop_page_id); ?>" class="button"><?php _e(
    'Browse products',
    'ercodingtheme',
); ?></a>
	</div>
