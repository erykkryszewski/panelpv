    ...
    <div class="container">
        <div class="row text-image-decorated__row <?php if('reverse' == $direction) { echo 'text-image-decorated__row--reverse'; } ?>">
            <div class="col-12 col-lg-8 col-xl-9">
                <div class="text-image-decorated__content"><?php echo apply_filters('acf_the_content', str_replace('&nbsp;', ' ', $text)); ?></div>
            </div>
            <?php if(!empty($image)): ?>
                <div class="col-12 col-lg-4 col-xl-3">
                    <div class="text-image-decorated__column">
                        <div>
                            ...
                            <?php if('true' == $circle) { echo 'text-image-decorated__picture--circle'; } ?>"><?php echo wp_get_attachment_image($image, 'large', '', ['class' => 'object-fit-cover']); ?></div>
