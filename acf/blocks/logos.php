...
$logos = get_field('logos'); $section_id = get_field('section_id'); $background = get_field('background');

?>

<?php if (is_array($logos) && count($logos) > 0): ?>
    <div class="logos <?php if ($background === 'true') { echo 'logos--background'; } ?>">
            ...
            <div class="logos__wrapper">
                <div class="logos__viewport">
                    <div class="logos__items" data-speed="140">
                        <?php $shuffled_1 = $logos; shuffle($shuffled_1); ?>
                        <?php foreach ($shuffled_1 as $item): ?>
                            ...
                            <?php endif; ?>
                        <?php endforeach; ?>
                        <?php $shuffled_2 = $logos; shuffle($shuffled_2); ?>
