            ...
            <div class="row">
                <div class="col-lg-6 col-xl-5">
                    <div class="contact__details">
                        <div class="contact__info contact__info--left">
                            <?php if (!empty($left_image)): ?>
                                <div class="contact__image"><?php echo wp_get_attachment_image($left_image, 'large', '', ['class' => 'object-fit-cover']); ?></div>
                            <?php endif; ?>
                        ...
                        <div class="contact__info contact__info--right">
                            <?php if (!empty($right_image)): ?>
                                <div class="contact__image"><?php echo wp_get_attachment_image($right_image, 'large', '', ['class' => 'object-fit-cover']); ?></div>
                            <?php endif; ?>
                    ...
                    <?php if (!empty($bottom_content)): ?>
                        <div class="contact__bottom-content"><?php echo apply_filters('the_title', $bottom_content); ?></div>
                    <?php endif; ?>
                </div>
                <div class="col-lg-6 col-xl-7">
                    <div class="contact__form ercoding-form"><?php echo gravity_form($form_id, false, false, false, '', false, 11); ?></div>
                </div>
            </div>
        </div>
    </div>
