...
<?php if ($loop -> have_posts()): ?>
    <div class="popular-products <?php if($hide_section == true) { echo 'display-none'; } ?>
    <?php if($background == 'true') { echo 'popular-products--background'; } ?>">
        ...
        <div class="popular-products__wrapper">
            <div class="row popular-products__row">
                <?php while ($loop -> have_posts()): ?>
                    <?php $loop->the_post(); $product_id = get_the_ID(); set_query_var('product_id', $product_id); ?>
