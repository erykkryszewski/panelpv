...
$hide_testimonials = get_field('hide_testimonials', 'options');

?>

<?php if (!empty($testimonials)): ?>
    <div class="testimonials <?php if ($background == 'true') { echo 'testimonials--background'; } ?>
    <?php if ($hide_testimonials == 'true') { echo 'testimonials--hidden'; } ?>">
                    ...
                    <div class="testimonials__item">
                        ...
                        <div class="testimonials__content">
                            <?php if (!empty($item['image'])): ?>
                                <div class="testimonials__image"><?php $file = get_attached_file($item['image'], 'medium'); $image_class = image_object_fit($file); ?>
                                    <?php echo wp_get_attachment_image($item['image'], 'testimonials', '', ['class' => $image_class]); ?></div>
                            <?php endif; ?>
                            <div>
