            ...
            <div class="theme-blog__wrapper">
              ...
              ?>
                        ...
                        <div class="<?php echo esc_attr($theme_blog_item); ?>">
                            ...
                            <?php if ($posts_number == 4) { echo 'theme-blog__image--smaller'; } ?>
                            <?php if ($is_video) { echo 'theme-blog__image--video'; } ?>">
                            <a href="<?php the_permalink(); ?>" class="cover"></a>
                            <?php echo wp_get_attachment_image(get_post_thumbnail_id(), 'medium', '', [ 'class' => 'object-fit-cover', ]); ?>
                        </div>
