            ...
            <div class="col-md-6">
                <div class="text-images__pictures-wrapper">
                    <?php if(!empty($left_image)): ?>
                        <div class="text-images__left-picture"><?php echo wp_get_attachment_image($left_image, 'text-images-left', '', ['class' => 'object-fit-cover']); ?></div>
                    <?php endif; ?>
                    <?php if(!empty($right_image)): ?>
                        <div class="text-images__right-picture"><?php echo wp_get_attachment_image($right_image, 'text-images-right', '', ['class' => 'object-fit-cover']); ?></div>
                    <?php endif; ?>
                    <?php if(!empty($top_image)): ?>
                        <div class="text-images__top-picture"><?php echo wp_get_attachment_image($top_image, 'text-images-top', '', ['class' => 'object-fit-cover']); ?></div>
                    <?php endif; ?>
                </div>
            </div>
        </div>
