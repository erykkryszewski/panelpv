    ...
    <div class="container">
        <div class="row text-with-image__row <?php if ('reverse' == $direction) { echo 'text-with-image__row--reverse'; } ?>">
            <div class="col-12 col-md-6 col-lg-7">
                ...
                <?php endif; ?>
                <div><?php echo apply_filters('acf_the_content', str_replace('&nbsp;', ' ', $text)); ?></div>
                <?php if (!empty($button)): ?>
            ...
            <?php if (!empty($image)): ?>
                <div class="col-12 col-md-6 col-lg-5">
                    ...
                    <?php if ('big' == $image_size) { echo 'text-with-image__picture--big'; } ?>
                    <?php if ('small' == $image_size) { echo 'text-with-image__picture--small'; } ?>"><?php echo wp_get_attachment_image($image, 'large', '', ['class' => $image_class]); ?></div>
            </div>
        <?php endif; ?>
    </div>
</div>
