...
<div class="two-columns-text <?php if('true' == $background) { echo 'text-with-image--background'; } ?>">
    ...
    <div class="container">
        ...
        <?php endif; ?>
        <div class="row">
            <div class="col-md-6"><?php echo apply_filters('acf_the_content', str_replace('&nbsp;', ' ', $left_column_text)); ?></div>
            <div class="col-md-6"><?php echo apply_filters('acf_the_content', str_replace('&nbsp;', ' ', $right_column_text)); ?></div>
        </div>
    </div>
</div>
