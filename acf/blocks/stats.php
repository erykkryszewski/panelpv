...
$section_id = get_field('section_id'); $background = get_field('background'); $stats = get_field('stats');
                ...
                <?php foreach($stats as $key => $item): ?>
                    <div class="stats__item">
                        <svg class="animated-number" viewbox="0 0 33.83098862 33.83098862" width="90" height="90" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <circle class="animated-number__circle" stroke="<?php echo ($item['value'] <= 49) ? '#db0000' : (($item['value'] > 49 && $item['value'] < 90) ? '#f5bf42' : '#089600'); ?>" stroke-width="2" stroke-dasharray="0,100" stroke-linecap="round" fill="none" cx="16.91549431" cy="16.91549431" r="15.91549431" data-dasharray="<?php echo esc_attr($item['value']); ?>"/>
