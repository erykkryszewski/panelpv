...
$section_id = get_field('section_id'); $background = get_field('background'); $boxes = get_field('boxes');

?>

<?php if (!empty($boxes)): ?>
    <div class="five-boxes <?php if ($background == 'true') { echo 'five-boxes--background'; } ?>">
                    ...
                    <div class="five-boxes__column">
                        <div class="five-boxes__item">
                            <?php if (!empty($item['image'])): ?>
                                <div class="five-boxes__image cover"><?php echo wp_get_attachment_image($item['image'], 'full', '', ['class' => 'object-fit-cover']); ?></div>
                            <?php endif; ?>
