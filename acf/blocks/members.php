                ...
                <div class="row members__row">
                    <?php if (!empty($item['logo'])): ?>
                        <div class="col-12 col-md-5 col-lg-3">
                            <div class="members__logo"><?php echo wp_get_attachment_image($item['logo'], 'large', '', ['class' => '']); ?></div>
                        </div>
                    <?php endif; ?>

                    <div class="col-12 col-md-7 col-lg-9">
                        <?php if (!empty($item['text'])): ?>
                            <div class="members__content"><?php echo apply_filters('the_title', $item['text']); ?></div>
                        <?php endif; ?>
                    </div>
                </div>
            <?php endforeach; ?>
