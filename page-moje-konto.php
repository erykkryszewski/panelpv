    ...
    if ($panelpvIsLockedOut === false) {
        if (wp_verify_nonce($_POST['panelpv_login_nonce'], 'panelpv_login_action')) {
            ...
            if (is_wp_error($panelpvUser)) {
                ...
                set_transient(
                    $panelpvRateKey,
                    ['count' => $panelpvCurrentCount, 'locked' => $panelpvShouldLock],
                    $panelpvLockMinutes * MINUTE_IN_SECONDS,
                );
                        ...
                        <?php if (!is_user_logged_in()): ?>
                            <div class="panelpv-my-account__box panelpv-my-account__box--login">
                                <div class="panelpv-my-account__head">
                                    <h3 class="panelpv-my-account__title"><?php echo esc_html__(
                                        'Zaloguj się',
                                        'panelpv',
                                    ); ?></h3>
                                </div>
                                ...
                                <?php if (!empty($panelpvLoginErrorMessage)): ?>
                                    <div class="panelpv-my-account__notice panelpv-my-account__notice--error">
                                        <div class="panelpv-my-account__notice-text"><?php echo esc_html(
                                            $panelpvLoginErrorMessage,
                                        ); ?></div>
                                    </div>
                                <?php endif; ?>
                                ...
                                <?php if ($panelpvIsLockedOut === true): ?>
                                    <div class="panelpv-my-account__notice panelpv-my-account__notice--lock">
                                        <div class="panelpv-my-account__notice-text"><?php echo esc_html__(
                                ...
                                <form class="panelpv-my-account__form panelpv-my-account__form--login" method="post" action="<?php echo esc_url(
                                    get_permalink(),
                                ); ?>">
                                    <div class="panelpv-my-account__field">
                                        <label class="panelpv-my-account__label" for="panelpv_login"><?php echo esc_html__(
                                    ...
                                    <div class="panelpv-my-account__field">
                                        <label class="panelpv-my-account__label" for="panelpv_password"><?php echo esc_html__(
                                            'Hasło',
                                            'panelpv',
                                        ); ?></label>
                                    ...
                                    <input type="hidden" name="panelpv_redirect_to" value="<?php echo esc_attr(
                                        $panelpvRedirectTarget,
                                    ); ?>">
                                    <?php wp_nonce_field('panelpv_login_action', 'panelpv_login_nonce'); ?>
                                    <div>
                                        <button class="panelpv-my-account__button panelpv-my-account__button--primary button mt-3" type="submit"><?php echo esc_html__(
                                            'Zaloguj',
                                            'panelpv',
                                        ); ?></button>
                                        <a class="panelpv-my-account__link panelpv-my-account__link--muted" href="<?php echo esc_url(
                                            wp_lostpassword_url(get_permalink()),
                                        ); ?>"><?php echo esc_html__('Nie pamiętasz hasła?', 'panelpv'); ?></a>
                                    </div>
                                </form>
                            </div>
                        <?php else: ?>
                            <div class="panelpv-my-account__box panelpv-my-account__box--logged">
                                <div class="panelpv-my-account__body">
                                    <div class="panelpv-my-account__user">
                                        <h4 class="panelpv-my-account__user-label"><?php echo esc_html__(
                                            'Zalogowano jako',
                                            'panelpv',
                                        ); ?>&nbsp;</h4>
                                        <h4 class="panelpv-my-account__user-name"><?php echo esc_html(
                                            wp_get_current_user()->display_name,
                                        ); ?></h4>
                                    </div>
                                    <div class="panelpv-my-account__actions panelpv-my-account__actions--row">
                                        <a class="panelpv-my-account__button panelpv-my-account__button--secondary button" href="<?php echo esc_url(
                                            home_url('/'),
                                        ); ?>"><?php echo esc_html__('Materiały', 'panelpv'); ?></a>
                                        <form class="panelpv-my-account__form panelpv-my-account__form--logout" method="post" action="<?php echo esc_url(
                                            get_permalink(),
                                        ); ?>">
                                            <?php wp_nonce_field('panelpv_logout_action', 'panelpv_logout_nonce'); ?>
                                            <button class="panelpv-my-account__button panelpv-my-account__button--danger panelpv-my-account__logout button" type="submit"><?php echo esc_html__(
                                                'Wyloguj',
                                                'panelpv',
                                            ); ?></button>
                                        </form>
