        ...
        <header class="header <?php if (!is_front_page()) { echo 'header--subpage'; } ?>">
            ...
            <div class="container">
                <nav class="nav <?php if (!is_front_page()) { echo 'nav--subpage'; } ?>">
                    <a href="/" class="nav__logo <?php if (!is_front_page()) { echo 'nav__logo--subpage'; } ?>"><?php if (!empty($global_logo)) { echo wp_get_attachment_image($global_logo, 'full', '', ['class' => '']); } else { echo 'Logo'; } ?></a>
                        ...
                        <?php if (!empty($header_button) || !empty($header_second_button)): ?>
                            <div class="nav__buttons">
                                <?php if (!empty($header_button)): ?>
                                    <a href="<?php echo esc_url($header_button['url']); ?>" target="<?php echo !empty($header_button['target']) ? esc_attr($header_button['target']) : '_self'; ?>" class="button nav__button nav__button--first <?php if (!is_front_page()) { echo 'nav__button--subpage'; } ?>"><?php echo esc_html($header_button['title']); ?></a>
                                <?php endif; ?>
                                <?php if (!empty($header_second_button)): ?>
                                    <a href="<?php echo esc_url($header_second_button['url']); ?>" target="<?php echo !empty( $header_second_button['target'] ) ? esc_attr($header_second_button['target']) : '_self'; ?>" class="button nav__button nav__button--second <?php if (!is_front_page()) { echo 'nav__button--subpage'; } ?>"><?php echo esc_html($header_second_button['title']); ?></a>
                                <?php endif; ?>
                            </div>
                        <?php endif; ?>
